...
import Celtics from "./pages/celtics.js";
  ...
  function handleLeave() {
    ...
    return (
      ...
      <div className="App">
        ...
        <Link to = "/pages/celtics" className = "box">Celtics</Link>
        <Switch>
          <Route path = "/pages/celtic" component={Celtics} />
        </Switch>
        ...
        <div className = "division">
          ...
          <div className = "row">
            <Link to = "/pages/celtics.js" className = "box">
            ...
            <a href = "/pages/nets.js" className = "box">
            ...
            <a href = "/pages/knicks.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/76ers.js" className = "box">
            ...
            <a href = "/pages/raptors.js" className = "box">
        ...
        <div className = "division">
          ...
          <div className = "row">
            <a href = "/pages/bulls.js" className = "box">
            ...
            <a href = "/pages/cavs.js" className = "box">
            ...
            <a href = "/pages/pistons.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/pacers.js" className = "box">
            ...
            <a href = "/pages/bucks.js" className = "box">
        ...
        <div className = "division">
          ...
          <div className = "row">
            <a href = "/pages/hawks.js" className = "box">
            ...
            <a href = "/pages/hornets.js" className = "box">
            ...
            <a href = "/pages/heat.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/magic.js" className = "box">
            ...
            <a href = "/pages/wizards.js" className = "box">
        ...
        <div className = "division">
          ...
          <div className = "row">
            <a href = "/pages/nuggets.js" className = "box">
            ...
            <a href = "/pages/timberwolves.js" className = "box">
            ...
            <a href = "/pages/thunder.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/trail-blazers.js" className = "box">
            ...
            <a href = "/pages/jazz.js" className = "box">
        ...
        <div className = "division">
          ...
          <div className = "row">
            <a href = "/pages/warriors.js" className = "box">
            ...
            <a href = "/pages/clippers.js" className = "box">
            ...
            <a href = "/pages/lakers.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/suns.js" className = "box">
            ...
            <a href = "/pages/kings.js" className = "box">
        ...
        <div className = "division">
          ...
          <div className = "row">
            <a href = "/pages/mavericks.js" className = "box">
            ...
            <a href = "/pages/rockets.js" className = "box">
            ...
            <a href = "/pages/grizzlies.js" className = "box">
          ...
          <div className = "row">
            <a href = "/pages/pelicans.js" className = "box">
            ...
            <a href = "/pages/spurs.js" className = "box">
